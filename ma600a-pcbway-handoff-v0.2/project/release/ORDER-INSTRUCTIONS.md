...
This is an electrically reviewed prototype release. Magnet geometry, the controller cable and operation on real hardware still require the tests below. Read `Design-review.md`, including the native-ERC coverage limitation, before authorizing fabrication.
