...
Four_point_five_point_radius = 41.11 + 14.44 + 0.1; // Must likely be enlargened to fit head
Extruder_motor_twist = -17;
...
Pitch_difference_extruder = 20; // Two radiis echoed during compil..
Shaft_flat = 2;
Motor_gear_teeth = 13;
