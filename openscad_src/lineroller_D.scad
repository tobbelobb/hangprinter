...
module lineroller_D(){
  ...
  flerp1 = 4;
  base_th = 2;
  lineroller_ABC_winch(edge_start=90) base(flerp0=flerp0);
  swing_r = 2;
  ...
  difference(){
    union(){
      cube([Tower_h+swing_r, d, base_th]);
