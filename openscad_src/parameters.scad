...
Spool_teeth = 100;
Spool_r = 55;
Spool_height = 11;  //standard was 8 (for a spool taking all lines at once, i.e. no separation disc)
Num_sep_holes= 3; // number of separation holes to be placed in the side of the spool. Serves as anchor point but also for separation the different lines only 1 (for up to 1 separation disc, i.e. 2 lines) or 2 (for the D spool) makes sense imho
Sep_disc_th = 1.0;
